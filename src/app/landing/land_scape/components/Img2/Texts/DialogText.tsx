...
import {
  uploadFileTextEn,
  uploadFileTextEs,
} from "../../../hooks/Img1/FetchText";
import { useTextStore } from "../../../store/Img2/UseText";
import { toast } from "react-toastify";
import { Input } from "@/components/ui/input";
import { useLanguage } from "@/components/navbar/Navbar";

export const DialogText2: React.FC = () => {
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div className="bg-[#29292965] absolute top-60 left-0 cursor-pointer z-10 flex items-center justify-center h-14 w-14">
