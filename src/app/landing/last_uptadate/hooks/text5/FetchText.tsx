export const fetchTextEn = async (): Promise<{
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/by-id/6703ee4eb3493fa160767698`
    );
...
export const fetchTextEs = async (): Promise<{
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/by-id/6703ee56b3493fa16076769a`
    );
...
export const uploadFileTextEn = async (title: string, body: string) => {
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/6703ee4eb3493fa160767698`,
      {
        method: "PATCH",
        headers: {
...
export const uploadFileTextEs = async (title: string, body: string) => {
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/6703ee56b3493fa16076769a`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
