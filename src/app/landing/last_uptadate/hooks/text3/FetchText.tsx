export const fetchTextEn = async (): Promise<{
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/by-id/6703ebd0b3493fa1607675da`
    );
...
export const fetchTextEs = async (): Promise<{
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/by-id/6703ebdbb3493fa1607675dc`
    );
...
export const uploadFileTextEn = async (title: string, body: string) => {
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/6703ebd0b3493fa1607675da`,
      {
        method: "PATCH",
        headers: {
...
export const uploadFileTextEs = async (title: string, body: string) => {
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/6703ebdbb3493fa1607675dc`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
