...
export const GetText = () => {
  ...
  return (
    <>
      <span
        ref={scrollTextRef}
        className="absolute text-white right-0 text-right top-[30%] xl:top-[30%] overflow-hidden font-[HelveticaThinItalic] tracking-[.1rem] w-44 md:text-[1rem] text-[0.75rem]"
      >
        {title}
      </span>
    </>
