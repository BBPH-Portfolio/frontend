export const fetchTextEn = async (): Promise<{
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/by-id/67036ffda8702f320bc4b526`
    );
...
export const fetchTextEs = async (): Promise<{
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/by-id/6703702fa8702f320bc4b528`
    );
...
export const uploadFileTextEn = async (title: string, body: string) => {
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/67036ffda8702f320bc4b526`,
      {
        method: "PATCH",
        headers: {
...
export const uploadFileTextEs = async (title: string, body: string) => {
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/6703702fa8702f320bc4b528`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
