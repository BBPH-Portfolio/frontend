export const fetchTextEn = async (): Promise<{
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/by-id/6916132266d8efdd5a309681`
    );
...
export const fetchTextEs = async (): Promise<{
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/by-id/691612ef66d8efdd5a30967f`
    );
...
export const uploadFileTextEn = async (title: string, body: string) => {
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/6916132266d8efdd5a309681`,
      {
        method: "PATCH",
        headers: {
...
export const uploadFileTextEs = async (title: string, body: string) => {
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/texts/691612ef66d8efdd5a30967f`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
