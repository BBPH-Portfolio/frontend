export const fetchImageUrl = async (): Promise<string | null> => {
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/images/6916204066d8efdd5a309770`
    );
...
export const uploadFileImage = async (file: File) => {
  ...
  const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/images/6916204066d8efdd5a309770`, {
    method: "PATCH",
    headers: {
