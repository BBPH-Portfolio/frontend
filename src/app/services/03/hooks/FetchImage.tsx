export const fetchImageUrl = async (): Promise<string | null> => {
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/images/691622c566d8efdd5a309776`
    );
...
export const uploadFileImage = async (file: File) => {
  ...
  const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/images/691622c566d8efdd5a309776`, {
    method: "PATCH",
    headers: {
